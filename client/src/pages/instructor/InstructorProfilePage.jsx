          ...
          {stats && (
            <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
              {[
                ...
                <div key={s.label} style={{ background: "rgba(255,255,255,0.15)", borderRadius: 14, padding: "12px 24px", textAlign: "center" }}>
                  <div style={{ fontSize: 22, fontWeight: 900, color: "#fff" }}>{s.value}</div>
                  <div style={{ fontSize: 11, color: "rgba(255,255,255,0.7)", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.07em" }}>{s.label}</div>
                </div>
              ))}
            </div>
          )}
          ...
          <form onSubmit={handleSave}>
            ...
            <Field label="Bio">
              <textarea
                ...
                placeholder="Tell students about yourself, your expertise, and what you teach…"
              />
            </Field>
            <button
              type="submit"
